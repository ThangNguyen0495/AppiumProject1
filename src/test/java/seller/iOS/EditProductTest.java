...
public class EditProductTest extends BaseTest {
    ...
    @BeforeGroups(groups = "[iOS][UPDATE] IMEI product - Without variation")
    ...
    @Test(groups = "[iOS][UPDATE] Normal product - Without variation")
    void UP_PRODUCT_G1_01_UpdateProductWithoutDimension() {
        editProductScreen.getHasDimension(false)
                ...
                .updateProductWithoutVariation(1);
    }
    ...
    @Test(groups = "[iOS][UPDATE] Normal product - Without variation")
    void UP_PRODUCT_G1_01_UpdateProductWithDiscountPrice() {
    ...
    @Test(groups = "[iOS][UPDATE] IMEI product - Without variation")
    ...
    @Test(groups = "[iOS][UPDATE] IMEI product - Without variation")
    void UP_PRODUCT_G2_01_UpdateProductWithDiscountPrice() {
        editProductScreen.getHasDiscount(true)
                .navigateToProductDetailScreen(productId)
                .updateProductWithoutVariation(1);
    }
    ...
    @Test(groups = "[iOS][UPDATE] Normal product - Variation")
    ...
    @Test(groups = "[iOS][UPDATE] Normal product - Variation")
    void UP_PRODUCT_G3_01_UpdateProductWithDiscountPrice() {
        editProductScreen.getHasDiscount(true)
                .navigateToProductDetailScreen(productId)
                .updateProductWithVariation(1, 1);
    }
    ...
    void UP_PRODUCT_G3_11_UpdateProductInformationByEachVariation() {
        ...
        editProductScreen.navigateToProductDetailScreen(productId)
                .updateEachVariationInformation(1);
    }

    //G4: IMEI product with variation
    @Test(groups = "[iOS][UPDATE] IMEI product - Variation")

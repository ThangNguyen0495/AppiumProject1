...
public class ProductVariationElement {
    ...
    By loc_txtVariationDescription = By.xpath("//XCUIElementTypeStaticText[@name=\"Input product description\"]");
    ...
    By loc_icnInventory = By.xpath("//XCUIElementTypeImage[@name=\"icon_inventory\"]");
